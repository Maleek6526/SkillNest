...
const Login = () => {
    ...
    if (result.success) {
      Swal.fire({
        ...
        if (isLogin) {
          ...
          localStorage.setItem("userRole", mapUserTypeToRole(userType));
    ...
    onSuccess: async (tokenResponse) => {
      ...
      try {
        const res = await fetch(
          `${API_CONFIG.BASE_URL}/api/skill-nest/auth/users/google`,
          {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
  ...
  return (
    <div className="flex min-h-screen flex-col-reverse md:flex-row items-center">
      <div
        className={`w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center items-center transition-all duration-500 ease-in-out ${
        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="relative flex items-center justify-center">
              ...
              <div className="text-sm text-gray-500 bg-white px-3 relative">
                or continue with
              </div>
            </div>
      ...
      <div
        className={`hidden sm:flex w-full md:w-1/2 bg-[#E5DEFF] items-center justify-center p-8 min-h-[30vh] md:min-h-screen transition-all duration-500 ease-in-out ${
          ...
          {isLogin ? (
            <div className="text-center md:text-left">
              <h2 className="text-3xl font-bold text-[#1A1F2C] mb-4">
                Welcome Back to{" "}
                <span className="text-[#7E69AB]">SkillNest</span>
              </h2>
              <p className="text-gray-600 mb-6">
                Sign in to connect with top talents and opportunities in your
                industry.
              </p>
            ...
            <div className="text-center md:text-left">
              <h2 className="text-3xl font-bold text-[#1A1F2C] mb-4">
                Join <span className="text-[#7E69AB]">SkillNest</span> Today
              </h2>
              <p className="text-gray-600 mb-6">
                Create an account to showcase your skills or find the perfect
